  ...
  function init() {
    var myMap = new ymaps.Map('location', {
      ...
      myBalloonLayout = ymaps.templateLayoutFactory.createClass(
        ...
        '<ul class="location__marks"><li class="location__mark location__mark--location"><a href="./handler.php"></a></li><li class="location__mark location__mark--pin"><a href="./handler.php"></a></li></ul>'
      );
